	...
	<script type = "text/javascript" > 
		...
		$(document).ready(function(){
			$('[data-toggle="popover"]').popover({
				trigger: 'hover',
				content: '<b><p>Aayush Neelkanth<br>Email: aayush.neelkanth@gmail.com<br>Whatsapp: 7697733422</p><p>Peehoo Jain<br>Email: peehoojain2@gmail.com<br>Whatsapp: 9575400373</p></b>',
				html: true}
			);
  ...
  <body style="background-color: grey;">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<button class="btn btn-info" data-toggle="popover" data-placement="bottom">Contact Us</button>	
	  </div>
	</nav>
